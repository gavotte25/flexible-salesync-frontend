                      ...
                      <DropdownMenu>
                        ...
                        >
                          ...
                          <DropdownMenuGroup>
                            <DropdownMenuItem
                              onClick={() => {
                                navigate(`/private/setting/object-manager/${type.id}?tab=properties`);
                              }}
                            >
                            ...
                            <DropdownMenuItem
                              onClick={() => {
                                navigate(`/private/setting/object-manager/${type.id}?tab=relations`);
                              }}
                            >
                              <div className='flex items-center space-x-2'>
                                <Waypoints size='1rem' />
                            ...
                            {type.template && type.template.name === 'StageObject' && (
                              <DropdownMenuItem
                                onClick={() => {
                                  navigate(`/private/setting/object-manager/${type.id}?tab=stages`);
                                }}
                              >
                                <div className='flex items-center space-x-2'>
