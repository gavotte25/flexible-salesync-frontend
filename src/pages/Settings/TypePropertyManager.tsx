          ...
          <div className='mb-5 flex h-full flex-row items-center justify-start'>
            <div className='mr-2 h-10 w-10'>
              <Button
                ...
                onClick={() => {
                  navigate(`/private/setting/object-manager`);
                }}
              >
                <ArrowLeft size='1rem' />
              </Button>
              ...
              {(typeProperties?.template?.name === 'StageObject'
                ...
                return (
                  <p
                    ...
                    onClick={() => {
                      navigate(`/private/setting/object-manager/${typeId}?tab=${item.toLowerCase()}`);
                    }}
                  >
                    {item}
                  </p>
            ...
            <>
              <div className='my-2 flex h-fit flex-row justify-between'>
                ...
                <PrimaryButton
                  className='ml-2'
                  onClick={() => {
                    navigate(`/private/setting/object-manager/${typeId}/create`);
                  }}
                  showHeader={true}
                >
                  <Icon name='edit' />
